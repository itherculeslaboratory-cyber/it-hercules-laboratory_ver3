      ...
      <div className={cx("wrap")}>
        ...
        <section className={cx("block")} id="ui-templates">
          <div className={cx("section-head")}>
            ...
            <p className={cx("section-why")}>
              <b>なぜここに来る?</b> 自分の観測画面やOSテンプレを、部品を並べて組み立てたい時。組んだものはテンプレートとして保存し、みんなに共有できます(全観測対象・全員が対象)。
            </p>
          </div>
          <div className={cx("card")}>
          ...
          <div className={cx("card")}>
            <div className={cx("homework")}>
              ...
              <ul>
                ...
                <li><b>「壁の画面から作り始める」入口</b>: 観測登録・個体詳細・観測検索などの画面から「これをテンプレ化」で起動する入口は、それらの画面側への追加作業が必要で、まだ着手していません(裁定/横断作業待ち)。</li>
              </ul>
            </div>
            <p className={cx("source-note")}>
