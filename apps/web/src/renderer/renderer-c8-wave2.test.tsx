...
// (#5, table "actor" cell + list item_actor_field)/image-grid item_href+
// placeholder(#2)/KebabMenu(#3)/per-post stance vote buttons(#6, ThreadPostsNode
// 側は renderer-c8.test.tsx の隣接ファイル)。table の <=560px カード化(#7)は
// CSS のみ(globals.css)なので jsdom の viewport 非依存テストでは対象外。
