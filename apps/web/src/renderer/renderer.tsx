...
// carrying a meta line + optional Badge (+ V3-OBS-24 an optional per-item
// navigate button — item_action_screen/item_action_query/item_action_label —
// e.g. a similar-individual card's "引用として見る" citation button).
