...
//   (iii) row count === 72. Lineage: base 68 (route-matrix.csv header comment) →
...
//        protected)= 71 → V3-AIP-67(GitHub Issues/掲示板→AI要約スレ)が新規 1
//        route(infra-route-080: POST /ai-digest/sync・protected・requireRole
//        operator/admin)= 72。
