// CL-04: 70-route matrix ↔ deny-by-default 照合 (design-c2 §2).
...
//   (iii) row count === 70. Lineage: base 68 (route-matrix.csv header comment) →
...
describe("CL-04 route matrix (70 rows)", () => {
  it("has exactly 70 route rows", () => {
