...
//        protected)= 71 → 観測個体レーン(C8 obs-individuals)が +1 route(infra-route-
//        080: GET /match/convergence・protected)= 72 → 同レーンが +1 route(infra-route-
//        081: GET /individuals/lineage-check・protected)= 73。
