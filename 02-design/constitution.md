...
> **鮮度注記(2026-08-07 追記)**: 本文書は 2026-07-10 版のまま以後の改訂なし。以後の実装差分は `docs/MODULE-MAP.md`(2026-07-31 更新)を正とする。出典: `D:\claude\00-hq\reports\R0807-0e19cb-REPORT-2026-08-07-release-audit.md` §3-2。
