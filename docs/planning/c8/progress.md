...
| V3-IND-13 | 個体詳細(A2)を「個体のホーム画面」とし、観測(最新観測・履歴・成長曲線グラフ… | required | in_progress | e61f50b, d49dcd9, 3d89c63 |
...
| V3-IND-21 | 個体・血統情報の登録数と実在数を照合できる透明性プラットフォームを作り水増… | required | in_progress | e61f50b, 8b05247 |
| V3-IND-34 | 血統管理は複数系統(A:体格重視、C:色重視等)を並行してインライン累代させ、理… | required | done | 3f941f2 |
